...
<head prefix="og:http://ogp.me/ns#">
  ...
  <!-- Primary Meta Tags -->
  <title>PostCSS Discard Overridden - Liam Cottle&#39;s Blog</title>
  <meta name="title" content="PostCSS Discard Overridden - Liam Cottle&#39;s Blog">
  ...
  <meta property="og:url" content="https://blog.liamcottle.com/node_modules/postcss-discard-overridden/">
  <meta property="og:title" content="PostCSS Discard Overridden - Liam Cottle&#39;s Blog">
  ...
  <meta property="twitter:url" content="https://blog.liamcottle.com/node_modules/postcss-discard-overridden/">
  <meta property="twitter:title" content="PostCSS Discard Overridden - Liam Cottle&#39;s Blog">
...
<p><a href="https://github.com/postcss/postcss">PostCSS</a> plugin to discard overridden <code class="language-plaintext highlighter-rouge">@keyframes</code> or <code class="language-plaintext highlighter-rouge">@counter-style</code>.</p>

<p><code class="language-plaintext highlighter-rouge">@keyframes</code> or <code class="language-plaintext highlighter-rouge">@counter-style</code> will be overridden by those who share the same identifiers and appear later in stylesheets. So we can discard all of them except the last one. When defined inside a <code class="language-plaintext highlighter-rouge">@media</code> or <code class="language-plaintext highlighter-rouge">@supports</code> rule, <code class="language-plaintext highlighter-rouge">@keyframes</code> and <code class="language-plaintext highlighter-rouge">@counter-style</code> rules only override global rules in some of the client browsers so they need handled separately. This plugin has taken care of this and transforms the PostCss AST <strong>safely</strong>.</p>

<div class="language-css highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="k">@-webkit-keyframes</span> <span class="n">fade-in</span> <span class="p">{</span>
...
<span class="k">@media</span> <span class="p">(</span><span class="n">max-width</span><span class="p">:</span> <span class="m">500px</span><span class="p">)</span> <span class="p">{</span>
  <span class="k">@-webkit-keyframes</span> <span class="n">fade-in</span> <span class="p">{</span>
    <span class="err">0</span><span class="o">%</span> <span class="p">{</span>
      <span class="nl">opacity</span><span class="p">:</span> <span class="m">0</span><span class="p">;</span>
    <span class="p">}</span>
    <span class="err">100</span><span class="o">%</span> <span class="p">{</span>
...
<div class="language-css highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="k">@media</span> <span class="p">(</span><span class="n">max-width</span><span class="p">:</span> <span class="m">500px</span><span class="p">)</span> <span class="p">{</span>
  <span class="k">@-webkit-keyframes</span> <span class="n">fade-in</span> <span class="p">{</span>
    <span class="err">0</span><span class="o">%</span> <span class="p">{</span>
      <span class="nl">opacity</span><span class="p">:</span> <span class="m">0</span><span class="p">;</span>
    <span class="p">}</span>
