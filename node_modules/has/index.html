...
<head prefix="og:http://ogp.me/ns#">
  ...
  <!-- Primary Meta Tags -->
  <title>has - Liam Cottle&#39;s Blog</title>
  <meta name="title" content="has - Liam Cottle&#39;s Blog">
  ...
  <meta property="og:url" content="https://blog.liamcottle.com/node_modules/has/">
  <meta property="og:title" content="has - Liam Cottle&#39;s Blog">
  ...
  <meta property="twitter:url" content="https://blog.liamcottle.com/node_modules/has/">
  <meta property="twitter:title" content="has - Liam Cottle&#39;s Blog">
...
<div class="language-sh highlighter-rouge"><div class="highlight"><pre class="highlight"><code>npm <span class="nb">install</span> <span class="nt">--save</span> has
</code></pre></div></div>

<h2 id="usage">Usage</h2>

<div class="language-js highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">has</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="dl">'</span><span class="s1">has</span><span class="dl">'</span><span class="p">);</span>

<span class="nx">has</span><span class="p">({},</span> <span class="dl">'</span><span class="s1">hasOwnProperty</span><span class="dl">'</span><span class="p">);</span> <span class="c1">// false</span>
<span class="nx">has</span><span class="p">(</span><span class="nb">Object</span><span class="p">.</span><span class="nx">prototype</span><span class="p">,</span> <span class="dl">'</span><span class="s1">hasOwnProperty</span><span class="dl">'</span><span class="p">);</span> <span class="c1">// true</span>
</code></pre></div></div>
