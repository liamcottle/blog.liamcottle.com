...
<head prefix="og:http://ogp.me/ns#">
  ...
  <!-- Primary Meta Tags -->
  <title>[postcss][postcss]-normalize-url - Liam Cottle&#39;s Blog</title>
  <meta name="title" content="[postcss][postcss]-normalize-url - Liam Cottle&#39;s Blog">
  ...
  <meta property="og:url" content="https://blog.liamcottle.com/node_modules/postcss-normalize-url/">
  <meta property="og:title" content="[postcss][postcss]-normalize-url - Liam Cottle&#39;s Blog">
  ...
  <meta property="twitter:url" content="https://blog.liamcottle.com/node_modules/postcss-normalize-url/">
  <meta property="twitter:title" content="[postcss][postcss]-normalize-url - Liam Cottle&#39;s Blog">
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>npm install postcss-normalize-url --save
</code></pre></div></div>
...
<div class="language-css highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nt">h1</span> <span class="p">{</span>
    <span class="nl">background</span><span class="p">:</span> <span class="sx">url("http://site.com:80/image.jpg")</span>
<span class="p">}</span>
</code></pre></div></div>
...
<div class="language-css highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nt">h1</span> <span class="p">{</span>
    <span class="nl">background</span><span class="p">:</span> <span class="sx">url(http://site.com/image.jpg)</span>
<span class="p">}</span>
</code></pre></div></div>
...
<code class="language-plaintext highlighter-rouge">normalizeProtocol</code>, <code class="language-plaintext highlighter-rouge">stripHash</code> &amp; <code class="language-plaintext highlighter-rouge">stripWWW</code> are set to <code class="language-plaintext highlighter-rouge">false</code>.</p>
