...
<head prefix="og:http://ogp.me/ns#">
  ...
  <!-- Primary Meta Tags -->
  <title>[postcss][postcss]-minify-gradients - Liam Cottle&#39;s Blog</title>
  <meta name="title" content="[postcss][postcss]-minify-gradients - Liam Cottle&#39;s Blog">
  ...
  <meta property="og:url" content="https://blog.liamcottle.com/node_modules/postcss-minify-gradients/">
  <meta property="og:title" content="[postcss][postcss]-minify-gradients - Liam Cottle&#39;s Blog">
  ...
  <meta property="twitter:url" content="https://blog.liamcottle.com/node_modules/postcss-minify-gradients/">
  <meta property="twitter:title" content="[postcss][postcss]-minify-gradients - Liam Cottle&#39;s Blog">
...
<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>npm install postcss-minify-gradients
</code></pre></div></div>

<h2 id="example">Example</h2>

<p>Where possible, this module will minify gradient parameters. It can convert
linear gradient directional syntax to angles, remove the unnecessary <code class="language-plaintext highlighter-rouge">0%</code> and
<code class="language-plaintext highlighter-rouge">100%</code> start and end values, and minimise color stops that use the same length
...
<div class="language-css highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nt">h1</span> <span class="p">{</span>
    <span class="nl">background</span><span class="p">:</span> <span class="n">linear-gradient</span><span class="p">(</span><span class="n">to</span> <span class="nb">bottom</span><span class="p">,</span> <span class="m">#ffe500</span> <span class="m">0%</span><span class="p">,</span> <span class="m">#ffe500</span> <span class="m">50%</span><span class="p">,</span> <span class="m">#121</span> <span class="m">50%</span><span class="p">,</span> <span class="m">#121</span> <span class="m">100%</span><span class="p">)</span>
<span class="p">}</span>
</code></pre></div></div>
...
<div class="language-css highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nt">h1</span> <span class="p">{</span>
    <span class="nl">background</span><span class="p">:</span> <span class="n">linear-gradient</span><span class="p">(</span><span class="m">180deg</span><span class="p">,</span> <span class="m">#ffe500</span><span class="p">,</span> <span class="m">#ffe500</span> <span class="m">50%</span><span class="p">,</span> <span class="m">#121</span> <span class="m">0</span><span class="p">,</span> <span class="m">#121</span><span class="p">)</span>
<span class="p">}</span>
</code></pre></div></div>
