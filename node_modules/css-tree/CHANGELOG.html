...
<ul>
  ...
  <li>Lexer
    <ul>
      ...
      <li>Improved <code class="language-plaintext highlighter-rouge">&lt;length&gt;</code> production matching to claim “unitless zero” only if no other unfulfilled production can claim it</li>
      ...
      <li>Fixed checking that value has <code class="language-plaintext highlighter-rouge">var()</code> occurrences when value is a string (such values can’t be matched on syntax currently and fail with specific error that can be used for ignorance in validation tools)</li>
...
<ul>
  <li>Fixed <code class="language-plaintext highlighter-rouge">Tokenizer#getRawLength()</code>’s false positive balance match to the end of input in some cases (#56)</li>
  <li>Rename walker’s entry point methods to be the same as CSSTree exposed methods (i.e. <code class="language-plaintext highlighter-rouge">walk()</code>, <code class="language-plaintext highlighter-rouge">walkUp()</code> etc)</li>
  <li>Rename at-rule’s <code class="language-plaintext highlighter-rouge">expression</code> to <code class="language-plaintext highlighter-rouge">prelude</code> (since <a href="https://www.w3.org/TR/css-syntax-3/#at-rule">spec names it so</a>)
    <ul>
      <li><code class="language-plaintext highlighter-rouge">AtruleExpression</code> node type → <code class="language-plaintext highlighter-rouge">AtrulePrelude</code></li>
      <li><code class="language-plaintext highlighter-rouge">Atrule.expression</code> field → <code class="language-plaintext highlighter-rouge">Atrule.prelude</code></li>
      <li><code class="language-plaintext highlighter-rouge">parseAtruleExpression</code> parser’s option → <code class="language-plaintext highlighter-rouge">parseAtrulePrelude</code></li>
      <li><code class="language-plaintext highlighter-rouge">atruleExpression</code> parse context → <code class="language-plaintext highlighter-rouge">atrulePrelude</code></li>
      <li><code class="language-plaintext highlighter-rouge">atruleExpression</code> walk context reference → <code class="language-plaintext highlighter-rouge">atrulePrelude</code></li>
    </ul>
  </li>
</ul>
...
<ul>
  ...
  <li>Generator
    <ul>
      <li>Changed generator to produce <code class="language-plaintext highlighter-rouge">+n</code> when <code class="language-plaintext highlighter-rouge">AnPlusB.a</code> is <code class="language-plaintext highlighter-rouge">+1</code> to be “round-trip” with parser</li>
...
<ul>
        ...
        <ul>
          ...
          <li>Reworked group and multipliers representation in syntax tree:
            <ul>
              ...
              <li>Renamed <code class="language-plaintext highlighter-rouge">nonEmpty</code> Group’s property to <code class="language-plaintext highlighter-rouge">disallowEmpty</code></li>
  ...
  <li>Renamed field in resulting object of <code class="language-plaintext highlighter-rouge">property()</code> function: <code class="language-plaintext highlighter-rouge">variable</code> → <code class="language-plaintext highlighter-rouge">custom</code></li>
...
<ul>
  ...
  <li>Implemented parser options to specify what should be parsed in details (when option is <code class="language-plaintext highlighter-rouge">false</code> some part of CSS represents as balanced <code class="language-plaintext highlighter-rouge">Raw</code>):
    <ul>
      <li><code class="language-plaintext highlighter-rouge">parseAtruleExpression</code> – to parse at-rule expressions (<code class="language-plaintext highlighter-rouge">true</code> by default)</li>
      <li><code class="language-plaintext highlighter-rouge">parseSelector</code> – to parse rule’s selector (<code class="language-plaintext highlighter-rouge">true</code> by default)</li>
      <li><code class="language-plaintext highlighter-rouge">parseValue</code> - to parse declaration’s value (<code class="language-plaintext highlighter-rouge">true</code> by default)</li>
      <li><code class="language-plaintext highlighter-rouge">parseCustomProperty</code> – to parse value and fallback of custom property (<code class="language-plaintext highlighter-rouge">false</code> by default)</li>
    </ul>
  </li>
...
<ul>
  ...
  <li>Changed parser to use <code class="language-plaintext highlighter-rouge">StyleSheet</code> node type only for top level node (when context is <code class="language-plaintext highlighter-rouge">stylesheet</code>, that’s by default)</li>
  ...
  <li>Disallowed empty selectors for <code class="language-plaintext highlighter-rouge">Rule</code> (not sure if it’s correct but looks reasonable)</li>
